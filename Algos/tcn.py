...
class TemporalBlock2d(nn.Module):
    def __init__(self, n_inputs, n_outputs, kernel_size=3, stride=1, dilation=1, padding=2, dropout=0.2):
        ...
        self.fc_channel = nn.Conv2d(n_inputs+n_outputs, n_outputs, 1)
    ...
    def init_weights(self):
        ...
        if self.fc_channel is not None:
            self.fc_channel.weight.data.normal_(0, 0.01)
